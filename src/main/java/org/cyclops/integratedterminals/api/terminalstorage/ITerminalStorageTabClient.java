...
public interface ITerminalStorageTabClient<S extends ITerminalStorageSlot> {
    ...
    public default void onTabBackgroundRender(ContainerScreenTerminalStorage<?, ?> screen, GuiGraphicsExtractor guiGraphics, float f, int mouseX, int mouseY) {

    }

    public default void onCommonSlotRender(AbstractContainerScreen gui, GuiGraphicsExtractor guiGraphics, ContainerScreenTerminalStorage.DrawLayer layer,
