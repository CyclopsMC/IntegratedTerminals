...
public class TerminalStorageIngredientItemStackCraftingGridClear extends PacketCodec<TerminalStorageIngredientItemStackCraftingGridClear> {
    ...
    public static final Type<TerminalStorageIngredientItemStackCraftingGridClear> ID = new Type<>(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "terminal_storage_ingredient_itemstack_crafting_grid_clear"));
