...
public class TerminalStorageIngredientSlotClickResultPacket extends PacketCodec<TerminalStorageIngredientSlotClickResultPacket> {
    ...
    public static final Type<TerminalStorageIngredientSlotClickResultPacket> ID = new Type<>(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "terminal_storage_ingredient_slot_click_result"));
