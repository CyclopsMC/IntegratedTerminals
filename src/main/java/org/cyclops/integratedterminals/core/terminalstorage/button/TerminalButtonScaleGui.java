...
public class TerminalButtonScaleGui<T>
    ...
    public ButtonImage createButton(int x, int y) {
        return new ButtonImage(x, y,
                new TranslatableComponent("gui.integratedterminals.terminal_storage.scale"),
                (b) -> {},
    ...
    public void getTooltip(Player player, TooltipFlag tooltipFlag, List<Component> lines) {
        lines.add(new TranslatableComponent("gui.integratedterminals.terminal_storage.scale.info").withStyle(ChatFormatting.GRAY));
        lines.add(new TranslatableComponent(scale.getLabel()));
    }
