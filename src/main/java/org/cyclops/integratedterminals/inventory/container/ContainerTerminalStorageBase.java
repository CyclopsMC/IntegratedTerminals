        ...
        for (ITerminalStorageTab tab : TerminalStorageTabs.REGISTRY.getTabs()) {
            ...
            if (tabId.equals("integratedterminals:ender_chest")) {
                ...
                if (variableInventory.isPresent() && variableInventory.get() instanceof org.cyclops.integratedterminals.part.PartTypeTerminalStorage.State) {
                    ...
                    isUpgraded = partState.isEnderUpgraded();
                }
                // Check if this is a portable terminal with ender upgrade
                else if (this instanceof org.cyclops.integratedterminals.inventory.container.ContainerTerminalStorageItem) {
                    org.cyclops.integratedterminals.inventory.container.ContainerTerminalStorageItem itemContainer =
                        (org.cyclops.integratedterminals.inventory.container.ContainerTerminalStorageItem) this;
