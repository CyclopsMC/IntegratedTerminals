...
public class GameTestTerminalStorageEnderChest {
    ...
    public void testPortableEnderUpgradeRecipe(GameTestHelper helper) {
        Optional<RecipeHolder<?>> recipeHolder = helper.getLevel().recipeAccess()
                .byKey(ResourceKey.create(Registries.RECIPE,
                        Identifier.parse("integratedterminals:crafting/terminal_storage_portable_ender_upgrade")));
        ...
        helper.assertTrue(recipe.assemble(upgradedInput).isEmpty(),
